...
class BTCTREND extends Analyzer {
  ...
  static TIMEFRAMES = ['15m', '30m', '1h', '4h', '1d'];
  static MA = 'emac';
  ...
  addCandle(candle, io) {
    ...
    if (candle.symbol !== BTCTREND.SYMBOL) {
      return;
    }
    if (!BTCTREND.TIMEFRAMES.includes(candle.timeframe)) {
      return;
    }
