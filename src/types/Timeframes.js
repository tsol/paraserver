class Timeframes
{
    ...
    TFRAMES = [
        ...
        { name: '1h',  htf: '1d',  levelDays:  14, days: 31,   trade: true,  limit: 0, levelsLimitTime: 0, length: 1 * this.HOUR_LENGTH },
        { name: '30m', htf: '4h',  levelDays:   7, days: 14,   trade: false, limit: 0, levelsLimitTime: 0, length: 30 * this.MIN_LENGTH },
        { name: '15m', htf: '4h',  levelDays:   5, days: 7,    trade: false, limit: 0, levelsLimitTime: 0, length: 15 * this.MIN_LENGTH },
        { name: '5m',  htf: '4h',  levelDays:   5, days: 7,    trade: false, limit: 0, levelsLimitTime: 0, length: 15 * this.MIN_LENGTH },
        { name: '3m',  htf: '1h',  levelDays:   2, days: 3,    trade: true,  limit: 0, levelsLimitTime: 0, length: 3 * this.MIN_LENGTH },
        { name: '1m',  htf: '1h',  levelDays:   1, days: 3,    trade: true,  limit: 0, levelsLimitTime: 0, length: 1 * this.MIN_LENGTH },
